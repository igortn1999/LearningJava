...
public class BotaoCampo extends JButton 
	...
	public void eventoOcorreu(Campo campo, CampoEvento evento) {
		...
		default:
			aplicarEstiloPadrao();//REINICIAR vai cair aqui
		}
		
		SwingUtilities.invokeLater( () -> {//evitar problemas de renderização
			repaint();
			validate();
		});
	...
	//metodos atrelados à interface que não serão utilizados
